 ...
 * @version 1.0
 **/
public class MyBeanFactoryPriorityOrderedPostProcessor implements BeanFactoryPostProcessor,PriorityOrdered {
  ...
  public void postProcessBeanFactory(ConfigurableListableBeanFactory beanFactory) throws BeansException {
    ...
    propertyValues.addPropertyValue(new PropertyValue("dbName", "mysql"));
  }
}
