 ...
 * @version 1.0
 **/
public class MyBeanFactoryOrderedPostProcessor1 implements BeanFactoryPostProcessor, Ordered {
  ...
  public void postProcessBeanFactory(ConfigurableListableBeanFactory beanFactory)
    ...
    propertyValues.addPropertyValue(new PropertyValue("password", "zcq123"));
